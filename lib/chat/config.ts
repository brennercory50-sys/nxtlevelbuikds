...
const KNOWLEDGE_BASE: KnowledgeEntry[] = [
  // ─── Web Design ───
  {
    ...
    priority: 5,
    response: "Great question! Our website packages start at **$997** for a 5-page starter site and scale from there:\n\n• **Starter ($997)** — 5 pages, mobile responsive, basic SEO, 7-day launch\n• **Growth ($2,497)** — 10 pages, CMS, advanced SEO, blog, contact forms\n• **Custom (from $5,000)** — Fully custom design, e-commerce, API integrations, membership portals\n\nMost of our clients invest between $997 and $5,000+. The right fit depends on your goals. What kind of business do you run?",
    service: 'web-design',
