  ...
  return (
    <main>
      ...
      <section className="relative overflow-hidden" style={{minHeight:'65vh', display:'flex', flexDirection:'column', justifyContent:'flex-end'}}>
        <Image fill src="/images/about-bg.png" alt="NXT Level Builds team — Daytona Beach digital agency" className="object-cover object-[center_25%]" priority quality={80} sizes="100vw" />
