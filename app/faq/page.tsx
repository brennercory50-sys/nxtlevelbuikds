...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'How much does a website cost?', acceptedAnswer: { '@type': 'Answer', text: 'Simple sites start at $599 with a $150/mo growth plan — or you can pay upfront for a one-time build. Custom builds are quoted individually based on scope. Every project is priced transparently with no surprise fees.' } },
