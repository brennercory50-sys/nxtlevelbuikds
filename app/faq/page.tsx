...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { '@type': 'Question', name: 'What platform do you build on?', acceptedAnswer: { '@type': 'Answer', text: "We build on Next.js — a React framework that's significantly faster than WordPress, cleaner than page builders like Wix or Squarespace, and built for performance and SEO. Sites we build consistently score 90+ on Google PageSpeed." } },
    { '@type': 'Question', name: 'Do you do WordPress or Squarespace?', acceptedAnswer: { '@type': 'Answer', text: "We can work with WordPress for clients who need a specific CMS workflow, but we recommend against it for most small businesses. WordPress sites built on templates score 40–65 on mobile PageSpeed by default. Our Next.js builds score 90+, which directly affects how you rank on Google." } },
