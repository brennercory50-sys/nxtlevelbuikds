...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'How much does a website cost?', acceptedAnswer: { '@type': 'Answer', text: "Websites start at just $599 with a $150/mo growth plan — or you can pay upfront for a one-time build. Every project is custom, so we'll quote you based on exactly what you need." } },
    { '@type': 'Question', name: 'Do you charge monthly fees?', acceptedAnswer: { '@type': 'Answer', text: 'No — unless you want ongoing services like SEO management, Google Ads management, or monthly support. Every project is priced as a one-time build. You pay once, you own it forever.' } },
    { '@type': 'Question', name: 'Do you offer payment plans?', acceptedAnswer: { '@type': 'Answer', text: 'Yes. We offer a 50/50 split (half upfront, half at launch), a 3-payment plan spread over 3 months, or a monthly retainer for ongoing work. All plans are 0% interest with no credit check required.' } },
    { '@type': 'Question', name: 'What is included in the price?', acceptedAnswer: { '@type': 'Answer', text: 'Every package includes design mockups, custom development, mobile-first build, contact form setup, basic on-page SEO, and 30 days of post-launch support. Higher tiers include more pages, Google Ads setup, Google Business Profile optimization, and extended support.' } },
    { '@type': 'Question', name: 'How long does it take to build a website?', acceptedAnswer: { '@type': 'Answer', text: 'Most Starter and Professional websites are live within 7 business days of design approval. Larger Growth builds typically take 10–14 days. Every project starts with design — you approve every page before we write a single line of code.' } },
    { '@type': 'Question', name: 'What does the process look like?', acceptedAnswer: { '@type': 'Answer', text: 'Step 1: Discovery call (30 minutes) — we learn your goals and market. Step 2: Design mockups — you approve everything before build begins. Step 3: Build and integrate — clean code, forms, and tools wired up. Step 4: Launch and support — we handle deployment and stay available after go-live.' } },
    { '@type': 'Question', name: 'How many revisions are included?', acceptedAnswer: { '@type': 'Answer', text: "Unlimited design revisions during the design phase. We revise until you're completely happy with how the site looks and functions before we move to development. After launch, 30 days of post-launch adjustments are included." } },
    { '@type': 'Question', name: 'What do I need to provide to get started?', acceptedAnswer: { '@type': 'Answer', text: 'Business name, logo (if you have one), a description of your services, and any photos of your work or team. We handle copywriting, photography sourcing, and everything else. You can provide as much or as little as you have.' } },
    { '@type': 'Question', name: 'Do I own my website?', acceptedAnswer: { '@type': 'Answer', text: 'Yes — completely. You own the code, the domain, and all content. We hand everything over at launch. No lock-in, no monthly platform fees, and no dependency on us to keep your site running.' } },
    { '@type': 'Question', name: 'What platform do you build on?', acceptedAnswer: { '@type': 'Answer', text: "We build on Next.js — a React framework that's significantly faster than WordPress, cleaner than page builders like Wix or Squarespace, and built for performance and SEO. We build every site to a 90+ Google PageSpeed target." } },
    { '@type': 'Question', name: 'Do you do WordPress or Squarespace?', acceptedAnswer: { '@type': 'Answer', text: "We can work with WordPress for clients who need a specific CMS workflow, but we recommend against it for most small businesses. WordPress sites built on templates score 40–65 on mobile PageSpeed by default. We build to a 90+ target, which directly affects how you rank on Google." } },
    { '@type': 'Question', name: 'Can you take over my existing website?', acceptedAnswer: { '@type': 'Answer', text: "Yes. We can audit your current site, identify what's hurting your conversions and rankings, and either rebuild it cleanly or migrate it to our stack. We handle domain transfers, redirect mapping, and any SEO considerations during migration." } },
    { '@type': 'Question', name: 'How long does SEO take to work?', acceptedAnswer: { '@type': 'Answer', text: 'Local SEO (Google Maps / local pack rankings) typically shows movement within 60–90 days for most markets in Daytona Beach and Volusia County. Organic Google search rankings for competitive terms typically take 3–6 months of consistent work. We set expectations clearly upfront for every market.' } },
    { '@type': 'Question', name: 'What is the minimum Google Ads budget?', acceptedAnswer: { '@type': 'Answer', text: "We recommend a minimum of $600–$800/month in ad spend for Google Search Ads to get statistically meaningful data. Below that, campaigns don't get enough clicks to optimize effectively. For Local Services Ads (LSA), budgets can start lower since you're paying per lead." } },
    { '@type': 'Question', name: 'Do you guarantee Google rankings?', acceptedAnswer: { '@type': 'Answer', text: 'No — and any agency that does is lying. Rankings depend on dozens of factors including competition, domain authority, content quality, and Google algorithm changes. What we guarantee is transparent work, clear reporting, and results we can both see and measure.' } },
    { '@type': 'Question', name: 'What areas do you serve for local SEO?', acceptedAnswer: { '@type': 'Answer', text: 'We serve Port Orange, Ormond Beach, New Smyrna Beach, DeLand, Palm Coast, and surrounding Volusia and Flagler County markets. We also provide SEO services for businesses across Florida and nationally.' } },
  ],
};
...
const categories = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'What platform do you build on?', a: "We build on Next.js — a React framework that's significantly faster than WordPress, cleaner than page builders like Wix or Squarespace, and built for performance and SEO. We build every site to a 90+ Google PageSpeed target." },
      { q: 'Do you do WordPress or Squarespace?', a: "We can work with WordPress for clients who need a specific CMS workflow, but we recommend against it for most small businesses. WordPress sites built on templates score 40–65 on mobile PageSpeed by default. We build to a 90+ target, which directly affects how you rank on Google." },
