      ...
      <section className="bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
          ...
          <div className="relative flex flex-col justify-end p-16 overflow-hidden">
            <Image fill src="/images/contact-bg.jpg" alt="Contact NXT Level Builds — Daytona Beach FL web design agency" className="object-cover object-center" priority quality={95} sizes="50vw" />
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-5">
                {[
                  ...
                  { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>, label:'Email', val:'hello@nxtlevelbuilds.com' },
