...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with NXT Level Builds — Daytona Beach\'s web design and digital marketing agency. Call (386) 348-3072 or send us a message today.',
  ...
  twitter: {
    ...
    title: 'Contact | Web Design Agency Daytona Beach FL',
    description: 'Get in touch with NXT Level Builds — Daytona Beach web design and digital marketing agency. Call (386) 348-3072.',
  },
};
          ...
          <div className="relative flex flex-col justify-end p-16 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="space-y-5">
                  {[
                   { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.18 2 2 0 0 1 3.6 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.2a16 16 0 0 0 6.29 6.29l.61-.61a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>, label:'Phone', val:'(386) 348-3072', href:'tel:+13863483072' },
                   { icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>, label:'Email', val:'hello@nxtlevelbuilds.com', href:'mailto:hello@nxtlevelbuilds.com' },
