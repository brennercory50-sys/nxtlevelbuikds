  ...
  return (
    <main>
      ...
      <section className="relative py-28 overflow-hidden">
        <Image fill src="/images/services-bg.jpg" alt="Google Ads management — NXT Level Builds Daytona Beach" className="object-cover object-center" priority quality={95} sizes="100vw" />
