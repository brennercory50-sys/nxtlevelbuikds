  ...
  return (
    <main>
      ...
      <section className="relative py-28 overflow-hidden">
        <Image fill src="/images/services-bg.jpg" alt="Web design for home service companies Florida — NXT Level Builds" className="object-cover object-center" priority quality={80} sizes="100vw" />
      ...
      <section className="bg-accent py-16">
        <div className="container-site text-center">
          <h2 className="text-[28px] font-bold text-white mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>Ready to Get More Service Calls?</h2>
