  ...
  return (
    <main>
      ...
      <section className="relative py-28 overflow-hidden">
        <Image fill src="/images/services-bg.jpg" alt="Web design Port Orange FL — NXT Level Builds" className="object-cover object-center" priority quality={95} sizes="100vw" />
