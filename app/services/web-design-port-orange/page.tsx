...
const faqSchema = {
  ...
  '@type': 'FAQPage',
  mainEntity: [
    { '@type': 'Question', name: 'How competitive is web design SEO in Port Orange compared to Daytona?', acceptedAnswer: { '@type': 'Answer', text: "Port Orange competes differently than a lot of Volusia County — the market isn't just under-optimized, it's actively growing. New construction along the Dunlawton and Taylor Road corridors and the expanding Spruce Creek communities mean the pool of local searchers gets bigger every quarter, not just easier to rank for. Daytona Beach's search competition is largely fixed at this point; Port Orange's is still being built. That combination — real demand growth plus a local search landscape that hasn't caught up to it — means the businesses that rank today capture a customer base that keeps expanding underneath them." } },
    ...
    <main>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-2xl border border-[#e5e7eb] p-7">
              ...
              <p className="text-muted text-[14px] leading-relaxed">
                Port Orange competes differently than a lot of Volusia County — the market isn&apos;t just under-optimized, it&apos;s actively growing. New construction along the Dunlawton and Taylor Road corridors and the expanding Spruce Creek communities mean the pool of local searchers gets bigger every quarter, not just easier to rank for. Daytona Beach&apos;s search competition is largely fixed at this point; Port Orange&apos;s is still being built. That combination — real demand growth plus a local search landscape that hasn&apos;t caught up to it — means the businesses that rank today capture a customer base that keeps expanding underneath them.
              </p>
            </div>
            <div className="bg-white rounded-2xl border border-[#e5e7eb] p-7">
      ...
      <section className="bg-accent py-16">
        <div className="container-site text-center">
          ...
          <a href="tel:+13862590178" className="inline-flex items-center gap-2 text-white/90 hover:text-white text-[14px] font-semibold ml-4 transition-colors">or call (386) 259-0178</a>
        </div>
      </section>
    </main>
  );
