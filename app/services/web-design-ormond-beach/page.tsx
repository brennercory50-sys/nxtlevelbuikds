...
export const metadata: Metadata = {
  ...
  description: 'Custom web design in Ormond Beach, FL. Mobile-first websites built to rank locally and convert visitors into leads. Launched in 7 days. Serving Volusia County.',
};
  ...
  return (
    <main>
      ...
      <section className="relative py-28 overflow-hidden">
        <Image fill src="/images/services-bg.jpg" alt="Web design Ormond Beach FL — NXT Level Builds" className="object-cover object-center" priority quality={95} sizes="100vw" />
        ...
        <div className="container-site relative z-10">
          ...
          <p className="eyebrow" style={{ color: 'rgba(100,160,255,0.9)' }}>Web Design — Ormond Beach, FL</p>
          ...
          <p className="text-white/55 text-[16px] leading-relaxed max-w-lg mt-5 mb-8">
            Custom websites built for Ormond Beach service businesses. Mobile-first, fast-loading, and optimized for local search — so you rank when your customers are looking.
          </p>
      ...
      <section className="bg-white py-20">
        <div className="container-site">
          <p className="eyebrow">Serving Ormond Beach</p>
          <h2 className="section-title text-[clamp(26px,3.5vw,40px)] mb-6">Built for <span className="text-accent">Ormond Beach Businesses.</span></h2>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-muted text-[14px] leading-relaxed mb-4">
                Ormond Beach businesses compete across Volusia County for local search traffic. We build websites that rank for the searches your customers are making — and convert them when they land.
              </p>
              <p className="text-muted text-[14px] leading-relaxed mb-8">
                Every site we build is mobile-first, loads under 2 seconds, and comes with full on-page SEO targeting Ormond Beach and surrounding areas. Launched in 7 business days.
              </p>
            ...
            <div className="bg-[#f8f9fc] rounded-2xl p-8 border border-[#e5e7eb]">
              ...
              <ul className="space-y-3">
                {['Custom design for your brand','Mobile-first responsive build','Local SEO targeting Ormond Beach','Google Business Profile setup','Contact form + click-to-call','Fast hosting, live in 7 days','30-day post-launch support'].map(f => (
      ...
      <section className="bg-accent py-16">
        <div className="container-site text-center">
          <h2 className="text-[28px] font-bold text-white mb-3" style={{ fontFamily: "'Bebas Neue', sans-serif" }}>Ready to Grow Your Ormond Beach Business?</h2>
