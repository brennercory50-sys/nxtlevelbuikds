    ...
    <main>
      ...
      <section className="bg-accent py-16">
        <div className="container-site text-center">
          ...
          <p className="text-white text-[15px] mb-8 max-w-md mx-auto">Free 30-minute strategy call. No commitment. We&apos;ll show you exactly what&apos;s keeping your site from ranking and converting.</p>
