        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10 mb-12">
          <div className="md:col-span-1">
            ...
            <div className="flex gap-3 mt-5">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/nxtlevelbuilds" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="w-8 h-8 rounded-lg flex items-center justify-center transition-opacity hover:opacity-100 opacity-60" style={{ background: 'rgba(255,255,255,0.08)' }}>
              ...
              {/* X / Twitter */}
              <a href="https://x.com/nxtlevelbuilds" target="_blank" rel="noopener noreferrer" aria-label="X" className="w-8 h-8 rounded-lg flex items-center justify-center transition-opacity hover:opacity-100 opacity-60" style={{ background: 'rgba(255,255,255,0.08)' }}>
